  ...
  return (
    <div className="app">
      ...
      <p style={{ fontSize: 13, color: "#555" }}>
        Type in the textarea. Each keystroke is a CRDT operation on a Yjs <code>Y.Text</code>. Click{" "}
        <b>Save snapshot</b> to capture the current document state; click <b>Restore</b> on any
            ...
            history.map((snap) => (
              <div key={snap.id} className="snapshot">
                ...
                <div className="actions">
                  ...
                  <button className="danger" onClick={() => deleteSnapshot(snap.id)}>
                    Delete
                  </button>
                </div>
              </div>
